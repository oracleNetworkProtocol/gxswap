...
contract token {
    /* 公共变量 */
    string public name = 'dog coin'; //代币名称
    string public symbol = 'dog'; //代币符号比如'$'
    uint8 public decimals = 6;  //代币单位，展示的小数点后面多少个0,和以太币一样后面是是18个0
    uint256 public totalSupply = 1000000000000000; //代币总量
